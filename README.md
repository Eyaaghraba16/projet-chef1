...
Ce projet utilise des données en mémoire pour le backend (pas de base de données). Les données seront perdues au redémarrage du serveur. Pour une application réelle, connectez une vraie base de données comme vous l'avez mentionné.
